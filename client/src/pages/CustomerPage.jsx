...
const CustomerPage = () => {
  ...
  return (
    <>
      <Header />
      <h1 className="text-4xl font-bold text-center mb-7">Customers</h1>
      {invoiceItems ? (
        <div className="px-6">
          <Table dataSource={invoiceItems} columns={columns} scroll={{ x: 1000, y: 300 }} bordered pagination={false} className="border border-gray-200" />
        </div>
      ) : (
